...
__title__="FreeCAD Efoil Workbench - Init file"
...
class CurvedShapesWB (Workbench):
    def __init__(self):
        ...
        self.__class__.Icon = os.path.join(Efoil.get_module_path(), "Resources", "icons", "curvedArray.svg")
    ...
    def Initialize(self):
        ...
        self.list = ["EfoilWing", "CurvedPathArray", "CurvedSegment", "InterpolatedMiddle", "SurfaceCut", "NotchConnector", "LasercutterTechdrawExport"] # A list of command names created in the line above
