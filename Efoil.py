...
def makeEfoil(Base = None, 
                    ...
                    extract=False):
    import EfoilWing
    obj = FreeCAD.ActiveDocument.addObject("Part::FeaturePython","EfoilWing")
    EfoilWing.CurvedArrayWorker(obj, Base, Hullcurves, Path, Axis, Items, Position, OffsetStart, OffsetEnd, Twist, Surface, Solid, Distribution, DistributionReverse, False)
    EfoilWing.CurvedArrayViewProvider(obj.ViewObject)
