...
class SurfaceCutViewProvider:
    ...
    def getIcon(self):
        return (os.path.join(Efoil.get_module_path(), "Resources", "icons", "surfaceCut.svg"))
...
class SurfaceCut():
    ...
    def Activated(self):
        ...
        FreeCADGui.doCommand("Efoil.cutSurfaces(curves, Normal = FreeCAD.Vector(0, 0, 1), Position=FreeCAD.Vector(0,0,0), Face=False, Simplify=False)")
    ...
    def GetResources(self):
        return {'Pixmap'  : os.path.join(Efoil.get_module_path(), "Resources", "icons", "surfaceCut.svg"),
