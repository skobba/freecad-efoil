...
class NotchConnectorViewProvider:
    ...
    def getIcon(self):
        return (os.path.join(Efoil.get_module_path(), "Resources", "icons", "NotchConnector.svg"))
...
class NotchConnector():
    ...
    def Activated(self):
        ...
        FreeCADGui.doCommand("Efoil.makeNotchConnector(base, tools, CutDepth=50.0)")
        if len(selection) == 2:
            FreeCADGui.doCommand("Efoil.makeNotchConnector(tools[0], [base], CutDepth=-50.0)")            
    ...
    def GetResources(self):
        return {'Pixmap'  : os.path.join(Efoil.get_module_path(), "Resources", "icons", "NotchConnector.svg"),
